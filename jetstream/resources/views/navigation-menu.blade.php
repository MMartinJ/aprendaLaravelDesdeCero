    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <!-- Settings Dropdown -->
                {{-- si el usuario esta autenticado se muestra el menu de navegacion, sino, se muestran los enlaces de login y registro --}}
                <div class="ms-3 relative">
                    @auth
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @auth
            ...
            @else
                ...
                <x-responsive-nav-link href="{{ route('register') }}" :active="request()->routeIs('blog')">
                    {{ __('Register') }}
                </x-responsive-nav-link>
            @endauth
        </div>
